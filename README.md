...
- Monitoraggio in tempo reale dell'ingresso phono (sempre attivo)
...
- **PipeWire** con `pw-record`, `pw-loopback`
- **ALSA** con `aplay`
...
| `PLAYBACK_CARD` | `plughw:CARD=Headphones,DEV=0` | Dispositivo ALSA uscita |
...
| `PW_SINK` | `alsa_output.platform-...` | Nodo PipeWire sink |
| `PORT` | `5000` | Porta HTTP del server |
...
Apri il browser su `http://<ip-del-pi>:5000`.
